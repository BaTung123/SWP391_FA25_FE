...
import { FaChartLine, FaDownload, FaCalendarAlt, FaCar, FaUsers, FaClipboardList } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Bookings Processed</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <div className="space-y-3">
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <span className="text-gray-700">Processed booking #BK001 for John Doe</span>
            <span className="ml-auto text-sm text-gray-500">1 hour ago</span>
          </div>
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
            <span className="text-gray-700">Completed maintenance for Honda Civic</span>
            <span className="ml-auto text-sm text-gray-500">3 hours ago</span>
          </div>
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            <div className="w-2 h-2 bg-yellow-500 rounded-full mr-3"></div>
            <span className="text-gray-700">Scheduled maintenance for Toyota Camry</span>
